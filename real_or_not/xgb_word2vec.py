...
def main():
    ...
    cv_df.to_csv('~/Data/Kaggle/real_or_not/cross_val_summary_2_word2vec.csv', index=False)
    ...
    # Save scores
    subm_dfx.to_csv('~/Data/Kaggle/real_or_not/submissions/subm_xgb_w2v300.csv', index=False)
    pass

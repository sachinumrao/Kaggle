...
def main():
    ...
    train_data_file = 'train_s2v_300.npy'
    test_data_file = 'test_s2v_300.npy'
    ...
    random_cv.fit(x_train_t, y_train)

    # Save hyper parameter tuning results
    cv_df = pd.DataFrame.from_dict(random_cv.cv_results_)
    cv_df.to_csv('~/Data/Kaggle/real_or_not/cross_val_summary_2_word2vec_pca.csv', index=False)
    ...
    # Save scores
    subm_dfx.to_csv('~/Data/Kaggle/real_or_not/submissions/subm_xgb_w2v300_pca.csv', index=False)
    pass
